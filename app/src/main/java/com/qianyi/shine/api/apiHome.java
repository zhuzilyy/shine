...
public class apiHome {
    ...
    public static void willingSet(String url,String member_id,String cate_two_name,String major_id,String intention_area,String intention_major,String intention_job,RequestCallBack<String> callback){
        Map<String,String> params=new HashMap<>();
        params.put("member_id",member_id);
    ...
    //专业优先填报P
    public static void majorPriorMajor(String url,int page,String memberId,String majorId,String order,String area, RequestCallBack<String> callback){
        Map<String,String> params=new HashMap<>();
        params.put("page",page+"");
