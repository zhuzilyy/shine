...
public class MoreCollegeActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MoreCollegeActivity.this, "ok", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        //类型
        final ListView typeView = new ListView(MoreCollegeActivity.this);
        typeView.setDividerHeight(0);
        typeAdapter = new GirdDropDownAdapter(MoreCollegeActivity.this, Arrays.asList(typeDatas));
        ...
        orderView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mDropDownMenu.closeMenu();
                Toast.makeText(MoreCollegeActivity.this, "排序条目", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        typeView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mDropDownMenu.closeMenu();
                Toast.makeText(MoreCollegeActivity.this, "类型条目", Toast.LENGTH_SHORT).show();
        ...
        constellation.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(MoreCollegeActivity.this, "星座条目", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void initAdapter() {
        mAdapter = new EstablishAdapter(R.layout.morecollege_item,list_temp);
...
//        mAdapter.setPreLoadNumber(3);
    ...
    private void refresh() {
        Toast.makeText(MoreCollegeActivity.this, "1346458465", Toast.LENGTH_SHORT).show();
        mNextRequestPage = 1;
        ...
        apiHome.refresh("http://www.baidu.com", mNextRequestPage, new com.qianyi.shine.callbcak.RequestCallBack<String>() {
            ...
            public void onSuccess(Call call, Response response, String s) {
                Log.i("ppp","131"+s);
                MoreCollegeActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    private void setData(boolean isRefresh, List data) {
        ...
        if (size < PAGE_SIZE) {
            ...
            Toast.makeText(MoreCollegeActivity.this, "第一页如果不够一页就不显示没有更多数据布局", Toast.LENGTH_SHORT).show();
        } else {
