...
public class MajorAndJobDetailsActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        areaAdapter = new AreaAdapter(MajorAndJobDetailsActivity.this, Arrays.asList(citys));
        ...
        //排序
        final ListView orderView = new ListView(MajorAndJobDetailsActivity.this);
        orderAdapter = new GirdDropDownAdapter(MajorAndJobDetailsActivity.this, Arrays.asList(orderDatas));
        ...
        //填充布局
        View contentView = LayoutInflater.from(MajorAndJobDetailsActivity.this).inflate(R.layout.layout_refresh, null);
    ...
    private void initContentView() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MajorAndJobDetailsActivity.this));
        //上拉加载
        initAdapter();
        //下拉刷新
        initRefreshLayout();
    ...
    public void click(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_openVip:
                jumpActivity(MajorAndJobDetailsActivity.this, VipActivity.class);
                break;
        }
    }
